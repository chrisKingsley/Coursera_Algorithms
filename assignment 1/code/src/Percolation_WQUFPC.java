 ...
 *
 */
public class Percolation_WQUFPC {
	private boolean[][] grid = null;
	private int n, topSite, bottomSite, numOpen=0;
	WeightedQuickUnionPathCompressionUF unionFind, unionFind2;
	
	/**
	 * constructor
	 * @param N dimension of each axis of the grid
	 */
	public Percolation_WQUFPC(int N) {
		n = N;
		topSite = n*n;
		bottomSite = n*n+1;
		...
		unionFind = new WeightedQuickUnionPathCompressionUF(n*n+2);
		unionFind2 = new WeightedQuickUnionPathCompressionUF(n*n+1);
